...
List<DatingAppModel> getSettingData() {
  ...
  list.add(DatingAppModel(
      name: 'Edit your profile', widget: const PurchaseMoreScreen()));
  list.add(DatingAppModel(
      name: 'Change your password', widget: const PurchaseMoreScreen()));
  list.add(DatingAppModel(
      name: 'Change your location', widget: const PurchaseMoreScreen()));
  list.add(DatingAppModel(
      name: 'Notifications', widget: const PurchaseMoreScreen()));
...
List<DatingAppModel> getIdealList() {
  ...
  list.add(DatingAppModel(
      name: 'Love',
      widget: const Icon(Icons.favorite_border, color: white),
      color: redColor.withOpacity(0.7)));
  list.add(DatingAppModel(
      name: 'Friend',
      widget: const Icon(Icons.person_outline, color: white),
      color: royalBlue.withOpacity(0.7)));
  list.add(DatingAppModel(
      name: 'Fling',
      widget: const Icon(Icons.flip_camera_ios_outlined, color: white),
      color: mediumTurquoise.withOpacity(0.7)));
  list.add(DatingAppModel(
      name: 'Business',
      widget: const Icon(Icons.business, color: white),
